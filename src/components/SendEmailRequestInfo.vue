    ...
    <div class="request-form">
        <form action="" class="row" @submit="onSubmit">
            <template v-if="activeStep === 0">
                ...
                <div class="form-group col-md-6">
                    <label class="default" for="input-6">{{ $t('student_age')}}</label>
                    <input required type="email" v-model="studentAge" name="studentAge" class="form-control" id="input-6">
                </div>
                <div class="form-group col-md-6">
                    <label class="default" for="input-7">{{ $t('student_previous_school')}}</label>
                    <input required type="tel" v-model="studentPreviousSchool" name="studentPreviousSchool" class="form-control"
                           id="input-7">
                </div>
              <div class="form-group col-md-6">
                <label class="default" for="input-3">{{ $t('email_address')}}</label>
                <input required type="tel" v-model="email" name="email" class="form-control"
                       id="input-3">
              </div>
              <div class="form-group col-md-6">
                <label class="default" for="input-9">{{ $t('phone_number')}}</label>
...
<!--                                          class="form-control"></textarea>-->
            ...
            <div class="col-12 animated slideInRight cuestionary-form" v-if="activeStep === 2">
                <h2 class="bulgy-radios-title text-center">{{fullName}}, {{$t('custionary.text5')}} </h2>
            ...
            <div class="form-group col-md-12 buttons-container" >
                <input v-if="activeStep === 0" v-on:click="validateStep()" class="btn btn-primary py-3 px-5" v-bind:value=" $t('continue')">
                <input v-if="activeStep > 0" v-on:click="activeStep--" class="btn btn-primary py-3 px-5 previous" v-bind:value=" $t('prev')">
                <input v-if="activeStep === 1" v-on:click="validateStep()" class="btn btn-primary py-3 px-5" v-bind:value=" $t('continue')">
