        ...
        <form action="" class="row" @submit="onSubmit">
            <template v-if="activeStep === 0">
                <div class="form-group col-md-6">
                    <label class="default" for="input-1">{{ $t('first_name')}}:</label>
                    <input required type="text" v-model="firstName" name="firstName" class="form-control" id="input-1">
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-12 buttons-container" >
                <input v-if="activeStep === 0" v-on:click="validateStep()" class="btn btn-primary py-3 px-5" v-bind:value=" $t('start')">
        ...
        methods: {
            validateStep() {
                switch (this.activeStep) {
                    case 0:
                        if (!isUndefinedOrNullOrEmpty(this.firstName) && !isUndefinedOrNullOrEmpty(this.lastName) &&
